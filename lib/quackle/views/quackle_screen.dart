...
class QuackleScreen extends StatefulWidget {
  const QuackleScreen ({Key? key}): super(key: key);

  @override
  State<QuackleScreen> createState() => _QuackleScreenState();
}

class _QuackleScreenState extends State<QuackleScreen> {
  ...
  Future <void> _onEnterTapped() async {
    ...
    for (var i = 0; i < _currentWord!.letters.length; i++) {
      ...
      setState(() {
        if (currentWordLetter == currentSolutionLetter) {
          _currentWord!.letters[i] =
              currentWordLetter.copyWith(status: LetterStatus.correctWord);
      ...
      if (letter.status != LetterStatus.correctWord) {
